(() => {
    ...
    class CountdownTimer {
        ...
        _calc() {
            ...
            this._out.hoursTitle = CountdownTimer.declensionNum(hours, [ "hr", "hr", "hrs" ]);
            this._out.minutesTitle = CountdownTimer.declensionNum(minutes, [ "min", "mins", "mins" ]);
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        const deadline1 = new Date("2023/05/05");
        ...
        const deadline2 = new Date("2025/03/08");
        ...
        const deadline3 = new Date(Date.now() + 60 * 1e3 * 60 * 24 * 1835);
    ...
    const modeSwitch = body.querySelector(".menu__swith-mode");
    const header = body.querySelector(".header");
    const creators = body.querySelector(".creators");
    const mainTitle = body.querySelector(".main-title");
    const discover = body.querySelector(".discover");
    const burger = body.querySelector(".menu__body");
    const sellers = body.querySelector(".sellers");
    const showmoreSellers = body.querySelector(".menu-sellers__options");
    const modules_final = body.querySelector(".final");
    ...
    modeSwitch.addEventListener("click", (() => {
        ...
        creators.classList.toggle("dark");
        mainTitle.classList.toggle("dark");
        discover.classList.toggle("dark");
        burger.classList.toggle("dark");
        burger.classList.toggle("light");
        showmoreSellers.classList.toggle("lightdark");
        modules_final.classList.toggle("dark");
        footer.classList.toggle("lightdark");
        footer.classList.toggle("lightlight");
        sellers.classList.toggle("lightlight");
        sellers.classList.toggle("lightdark");
    }));
    const sellersMenu = document.querySelector(".sellers__menu"), selectBtn = sellersMenu.querySelector(".menu-sellers__button"), options = sellersMenu.querySelectorAll(".menu-sellers__option"), selectBtnText = sellersMenu.querySelector(".menu-sellers__button_text");
    sellersMenu.querySelector(".open");
    selectBtn.addEventListener("click", (function(event) {
        sellersMenu.classList.toggle("open");
    ...
    document.addEventListener("click", (function(event) {
        if (sellersMenu.classList.contains("open")) sellersMenu.classList.remove("open");
    }));
    options.forEach((option => {
        option.addEventListener("click", (() => {
            let selectedOption = option.querySelector(".menu-sellers__option_text").innerText;
            selectBtnText.innerText = selectedOption;
            sellersMenu.classList.remove("open");
        }));
    }));
    const sliderSellers = document.querySelector(".slider-sellers");
    const sliderCreators = document.querySelector(".slider-creators");
    const sliderTopRated = document.querySelector(".slider-top-rated");
    const selectSliderSellers = document.querySelector("#menu-slider-1");
    const selectSliderCreators = document.querySelector("#menu-slider-2");
    const selectSliderTopRated = document.querySelector("#menu-slider-3");
    selectSliderCreators.addEventListener("click", (() => {
        sliderSellers.classList.add("slider-hidden");
        sliderCreators.classList.remove("slider-hidden");
        sliderTopRated.classList.add("slider-hidden");
    }));
    selectSliderSellers.addEventListener("click", (() => {
        sliderSellers.classList.remove("slider-hidden");
        sliderCreators.classList.add("slider-hidden");
        sliderTopRated.classList.add("slider-hidden");
    }));
    selectSliderTopRated.addEventListener("click", (() => {
        sliderSellers.classList.add("slider-hidden");
        sliderCreators.classList.add("slider-hidden");
        sliderTopRated.classList.remove("slider-hidden");
    }));
    const stacksMenu = document.querySelector(".stacks-menu");
    const infoMenu = document.querySelector(".info-menu");
    const stacksMenuBtn = stacksMenu.querySelector(".stacks-menu__button");
    const infoMenuBtn = infoMenu.querySelector(".info-menu__button");
    stacksMenuBtn.addEventListener("click", (function(event) {
        stacksMenu.classList.toggle("open");
        event.stopPropagation();
    }));
    stacksMenuBtn.addEventListener("mousedown", (e => {
        e.preventDefault();
    }));
    document.addEventListener("click", (function() {
        if (stacksMenu.classList.contains("open")) stacksMenu.classList.remove("open");
    }));
    infoMenuBtn.addEventListener("click", (function(event) {
        infoMenu.classList.toggle("open");
        event.stopPropagation();
    }));
    infoMenuBtn.addEventListener("mousedown", (e => {
        e.preventDefault();
    }));
    document.addEventListener("click", (function() {
        if (infoMenu.classList.contains("open")) infoMenu.classList.remove("open");
    }));
    function isWebp() {
    ...
    function menuInit() {
        if (document.querySelector(".burger-menu")) document.addEventListener("click", (function(e) {
    ...
    function initSliders() {
        if (document.querySelector(".bid__slider")) {
            new core(".bid__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".slider-sellers__slider")) {
            new core(".slider-sellers__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
        ...
        if (document.querySelector(".slider-creators__slider")) {
            new core(".slider-creators__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
        ...
        if (document.querySelector(".slider-top-rated__slider")) {
            new core(".slider-top-rated__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
